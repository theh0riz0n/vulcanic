...
exports.default = async (keyPair, restUrl, pupil, dateFrom, dateTo) => {
    ...
    const url = `${strings.BASE_URL}/${tenant}/${pupil.Envelope[0].Unit.Symbol}/api/mobile/schedule/byPupil?unitId=${pupil.Envelope[0].Unit.Id}&pupilId=${pupil.Envelope[0].Pupil.Id}&periodId=${currentPeriod.Id}&dateFrom=${(0, moment_1.default)(dateFrom).format('YYYY-MM-DD')}&dateTo=${(0, moment_1.default)(dateTo).format('YYYY-MM-DD')}&pageSize=100`;
    const date = new Date();
