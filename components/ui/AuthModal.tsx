...
export default function AuthModal({ onSubmit, isLoading, error }: AuthModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold text-primary mb-4">Welcome to Dark Tide</h2>
        <p className="text-text-secondary mb-6">Please enter your API key and details to continue</p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Paste your APIAP string here"
              style={{ 
            ...
            <div className="mt-2 space-y-1 text-xs text-text-secondary">
              <p>
                Paste the complete APIAP string from the Vulcan login page. The correct format looks like:
              </p>
              ...
              <p>
                The APIAP string <strong>must</strong> be in this exact format with the HTML tags and input element.
              </p>
              <p>
                <a 
                  href="https://github.com/wulkanowy/qr" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                >
                  How to get your APIAP string?
                </a>
              </p>
            </div>
          </div>
